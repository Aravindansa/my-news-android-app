package com.sa.mynews.feature_weather.presentaion
...
import com.sa.mynews.core.data.location.LocationResource
import com.sa.mynews.core.data.remote.Resource
import com.sa.mynews.core.util.Constants
import com.sa.mynews.core.util.MyUtil
import com.sa.mynews.core.util.PermissionUtlil
import com.sa.mynews.core.util.collectLatestLifecycleFlow
import com.sa.mynews.core.util.getData
import com.sa.mynews.core.util.loadImage
import com.sa.mynews.databinding.FragmentWeatherBinding
import com.sa.mynews.feature_weather.domain.WeatherUtlil
import com.sa.mynews.feature_weather.domain.model.ForecastDay
import com.sa.mynews.feature_weather.domain.model.GraphType
import com.sa.mynews.feature_weather.domain.model.Hour
import com.sa.mynews.feature_weather.domain.model.WeatherGraph
import com.sa.mynews.feature_weather.domain.model.WeatherRes
import com.sa.mynews.feature_weather.domain.model.WeatherTab
